...
import { trackPurchase, trackRepairLead } from './utils/analytics';
...
// Los iconos de categoría (Beef, Fish, Milk…) viven ahora en
// src/components/CategoryIcon.jsx; aquí solo quedan los que usa App.
import {
  ShoppingCart, Search, Package, MapPin, Clock, ArrowLeft, ArrowRight,
  Tag, Trash2, ChevronRight, Home, Gift, Truck, Store, Heart,
  Loader2, Wrench, Smartphone,
  LayoutGrid, Percent, ClipboardList, User, LogOut, Plus, Minus, X, CreditCard, Lock, LogIn,
  ShieldCheck, FileText, Info, Users, Wallet, CheckCircle2, Phone, Mail,
  CalendarCheck, Sun, Moon,
} from "lucide-react";
import { useNavigate } from "react-router-dom";
import toast, { Toaster } from 'react-hot-toast';

// Contenido de la home (banners, aviso de promo, flag "más vendidos"):
// src/config/homeContent.js · Contacto WhatsApp: src/config/contact.js ·
// Tarifas de envío y zona de reparto: src/utils/shipping.js
import { BANNERS, PROMO_NOTICE, SHOW_MAS_VENDIDOS } from './config/homeContent';
...
// Componentes extraídos de este fichero (misma UI, sin cambios):
import ProductSkeleton from './components/ProductSkeleton';
import { StoreInfoBar, AfterHoursNotice } from './components/StoreStatus';
...
// [2026-07-03] El PaymentModal obsoleto (sin uso desde 2026-05-29, los
// métodos de pago se renderizan inline en el checkout) se eliminó en la
// limpieza que troceó este fichero.
